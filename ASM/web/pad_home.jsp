...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/pad_homestyle.css"/>
    ...
    <body>
        ...
        <div class="banner">
            <img class="banner_img" src="https://www.phongcachxanh.vn/cdn/shop/collections/lot-chuot-101817.webp?v=1676876795&width=1800" alt="alt"/>
        ...
        <form class="col-sm-5 filter_list" action="pad" method="get">
        ...
        <div class="page-content">
            <div class="container">
                <div class="product-content row" style="display: flex; justify-content: left;">
                    <c:forEach items="${sessionScope.FilterListPD}" var="product">
        ...
        <div class="paging_menu" style="display: flex;justify-content: center; margin: 20px 0px">
            ...
            <c:if test="${currentPage != 1}">
                <td><a href="pad?page=${currentPage - 1}"><i class="fa-solid fa-chevron-left" style="color: #000000;"></i></a></td>
                    </c:if>
            ...
            <c:if test="${currentPage lt noOfPages}">
                <td><a href="pad?page=${currentPage + 1}"><i class="fa-solid fa-chevron-right" style="color: #000000;"></i></a></td>
                    </c:if>
        </div>
