...
<html>
    ...
    <body>
        ...
        <div class="banner">
            <img class="banner_img" src="https://massdrop-s3.imgix.net/product-images/invyr-panda-mechanical-switches/FP/VP2uDa1OQdy1hQU19OhY_1500x1000_MD-91989_08.jpg?auto=format&fm=jpg&fit=crop&w=540&bg=f0f0f0&dpr=2&q=35" alt="alt"/>
        ...
        <form class="col-sm-5 filter_list" action="switch" method="get">
        ...
        <div class="page-content">
            <div class="container">
                <div class="product-content row" style="display: flex; justify-content: left;">
                    <c:forEach items="${sessionScope.FilterListSW}" var="product">
        ...
        <div class="paging_menu" style="display: flex;justify-content: center; margin: 20px 0px">
            ...
            <c:if test="${currentPage != 1}">
                <td><a href="switch?page=${currentPage - 1}"><i class="fa-solid fa-chevron-left" style="color: #000000;"></i></a></td>
                    </c:if>
            ...
            <c:if test="${currentPage lt noOfPages}">
                <td><a href="switch?page=${currentPage + 1}"><i class="fa-solid fa-chevron-right" style="color: #000000;"></i></a></td>
                    </c:if>
        </div>
